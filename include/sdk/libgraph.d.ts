// TypeScript definitions converted from ./include/sdk/libgraph.h
#ifndef _LIBGRAPH_H
#define _LIBGRAPH_H
...
export const SCE_GS_NOINTERLACE = (0);
export const SCE_GS_INTERLACE = (1);
export const SCE_GS_FIELD = (0);
export const SCE_GS_FRAME = (1);
export const SCE_GS_NTSC = (0x2);
export const SCE_GS_PAL = (0x3);
...
export const SCE_GS_ZNOUSE = (0);
export const SCE_GS_ZALWAYS = (1);
export const SCE_GS_ZGEQUAL = (2);
export const SCE_GS_ZGREATER = (3);
export const SCE_GS_NOCLEAR = (0);
export const SCE_GS_CLEAR = (1);
export const SCE_GS_MODULATE = (0);
export const SCE_GS_DECAL = (1);
export const SCE_GS_HILIGHT = (2);
#define SCE_GS_GHLIGHT2 SCE_GS_HIGHLIGHT2
#define SCE_GS_HIGHLIGHT2 (3)
export const SCE_GS_NEAREST = (0);
export const SCE_GS_LINEAR = (1);
export const SCE_GS_NEAREST_MIPMAP_NEAREST = (2);
export const SCE_GS_NEAREST_MIPMAP_LINEAR = SCE_GS_NEAREST_MIPMAP_LENEAR;
export const SCE_GS_NEAREST_MIPMAP_LENEAR = (3);
export const SCE_GS_LINEAR_MIPMAP_NEAREST = (4);
export const SCE_GS_LINEAR_MIPMAP_LINEAR = (5);
export const SCE_GS_PRIM_POINT = (0);
export const SCE_GS_PRIM_LINE = (1);
export const SCE_GS_PRIM_LINESTRIP = (2);
export const SCE_GS_PRIM_TRI = (3);
export const SCE_GS_PRIM_TRISTRIP = (4);
export const SCE_GS_PRIM_TRIFAN = (5);
export const SCE_GS_PRIM_SPRITE = (6);
export const SCE_GS_PRIM_IIP = (1 << 3);
export const SCE_GS_PRIM_TME = (1 << 4);
export const SCE_GS_PRIM_FGE = (1 << 5);
export const SCE_GS_PRIM_ABE = (1 << 6);
#define SCE_GS_PRIM_AA1 (1 << 7)
export const SCE_GS_PRIM_FST = (1 << 8);
#define SCE_GS_PRIM_CTXT1 (0)
#define SCE_GS_PRIM_CTXT2 (1 << 9)
export const SCE_GS_PRIM_FIX = (1 << 10);

export const SCE_GS_FALSE = (0);
export const SCE_GS_TRUE = (1);
