// TypeScript definitions converted from ./include/sdk/eestruct.h
#ifndef __eestruct__
#define __eestruct__
...
export const SCE_GIF_PACKED = 0;
export const SCE_GIF_REGLIST = 1;
export const SCE_GIF_IMAGE = 2;
export const SCE_GIF_PACKED_AD = 0x0e;
...
export const SCE_GS_SET_DISPLAY = SCE_GS_SET_DISPLAY_INTERLACE;

/* export const GS_PAL_MODE = */;
...
/*-- vertex info. reg--*/
export const SCE_GS_PRIM = 0x00;
export const SCE_GS_RGBAQ = 0x01;
export const SCE_GS_ST = 0x02;
export const SCE_GS_UV = 0x03;
#define SCE_GS_XYZF2 0x04
#define SCE_GS_XYZ2 0x05
export const SCE_GS_FOG = 0x0a;
#define SCE_GS_XYZF3 0x0c
#define SCE_GS_XYZ3 0x0d
#define SCE_GS_XYOFFSET_1 0x18
#define SCE_GS_XYOFFSET_2 0x19
export const SCE_GS_PRMODECONT = 0x1a;

/*-- drawing attribute reg. --*/
export const SCE_GS_PRMODE = 0x1b;
...
export const SCE_GS_TEXCLUT = 0x1c;
export const SCE_GS_SCANMSK = 0x22;
...
export const SCE_GS_TEXA = 0x3b;
export const SCE_GS_FOGCOL = 0x3d;
export const SCE_GS_TEXFLUSH = 0x3f;
...
export const SCE_GS_DIMX = 0x44;
export const SCE_GS_DTHE = 0x45;
export const SCE_GS_COLCLAMP = 0x46;
#define SCE_GS_TEST_1 0x47
#define SCE_GS_TEST_2 0x48
export const SCE_GS_PABE = 0x49;
...
export const SCE_GS_BITBLTBUF = 0x50;
export const SCE_GS_TRXPOS = 0x51;
export const SCE_GS_TRXREG = 0x52;
export const SCE_GS_TRXDIR = 0x53;
export const SCE_GS_HWREG = 0x54;

/*-- other reg. --*/
export const SCE_GS_SIGNAL = 0x60;
export const SCE_GS_FINISH = 0x61;
export const SCE_GS_LABEL = 0x62;
export const SCE_GS_NOP = 0x7f;
