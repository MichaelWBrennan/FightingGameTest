// TypeScript definitions converted from ./include/sdk/sifrpc.h
...
/* call & bind mode */
export const SIF_RPCM_NOWAIT = 0x01 /* not wait for end of function */;
export const SIF_RPCM_NOWBDC = 0x02 /* no write back d-cache .ee only */;

/* error no */
export const SIF_RPCE_GETP = 1  /* fail to get packet data */;
export const SIF_RPCE_SENDP = 2 /* fail to send dma packet */;
export const SIF_RPCE_CSEMA = 3 /* fail to get sema */;
...
void sceSifRegisterRpc(sceSifServeData *, unsigned int, sceSifRpcFunc, void *, sceSifRpcFunc, void *,
                       sceSifQueueData *);
