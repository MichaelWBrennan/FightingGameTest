// TypeScript definitions converted from ./include/sf33rd/AcrSDK/ps2/foundaps2.h
#ifndef FOUNDAPS2_H
#define FOUNDAPS2_H
...
export const VRAM_CONTROL_SIZE = 1344;
export const VRAM_BLOCK_HEADER_SIZE = 3;
export const LOAD_CHECK_TIME_SIZE = 20;
export const DEBUG_TRUE_TIME_SIZE = 4;
export const DEBUG_SYS_MEM_SIZE = 4096;
export const FL_PALETTE_MAX = 1088;
export const FL_TEXTURE_MAX = 256;
