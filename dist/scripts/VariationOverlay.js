...
export class VariationOverlay {
     ...
     */
    applyRemoves(target, removes, diff) {
     ...
     */
    isProtectedField(path) {
        return this.PROTECTED_FIELDS.some(protected => path === protected || path.startsWith(protected + '.'));
    }
    /**
     ...
     */
    applyNumericModification(currentValue, modification) {
     ...
     */
    logVariationDiff(variationId, diff) {
        const summary = {
     ...
     */
    generateDiffReport(base, variation) {
     ...
     */
    testIdempotence(base, variation) {
 ...
 */ 
//# sourceMappingURL=VariationOverlay.js.map