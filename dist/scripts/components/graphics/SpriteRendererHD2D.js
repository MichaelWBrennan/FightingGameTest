...
SpriteRendererHD2D.prototype.initialize = function () {
    this.stageLayerManager = this.app.root.findOne((node) => !!node.script?.stageLayerManager)?.script?.stageLayerManager;
...
SpriteRendererHD2D.prototype.update = function (dt) {
...
//# sourceMappingURL=SpriteRendererHD2D.js.map