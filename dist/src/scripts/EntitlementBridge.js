...
export class EntitlementBridge {
     ...
     */
    grantTemporaryAccess(characterId, durationMs = 24 * 60 * 60 * 1000) {
        if (!this.entitlements.qaFlags.temporaryUnlocks.includes(characterId)) {
    ...
    getEntitlementSummary() {
        return {
            ...
            availablePlatforms: Array.from(this.platformProviders.keys()).filter(name => this.platformProviders.get(name).isAvailable())
        };
    }
    /**
 ...
 */ 
//# sourceMappingURL=EntitlementBridge.js.map