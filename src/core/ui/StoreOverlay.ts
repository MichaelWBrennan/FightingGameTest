export class StoreOverlay {
  ...
  constructor() {
    ...
    const title = document.createElement('div'); title.textContent = 'Store'; title.style.fontWeight = 'bold'; title.style.marginBottom = '8px'; this.container.appendChild(title);
    ...
    const toggle = document.createElement('button'); toggle.textContent = 'Store (F10)'; toggle.style.position = 'fixed'; toggle.style.left = '8px'; toggle.style.top = '40px'; toggle.style.zIndex = '10007'; toggle.onclick = () => this.toggle();
